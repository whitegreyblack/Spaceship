...
class Main(Scene):
    ...
    def reset(self):
        ...
        header = self.title_height + len(self.title.split('\n'))
        self.options_height = self.calc_options_heights(header, 3)
    ...
    def calc_options_heights(self, header:int, footer:int) -> list:
        ...
        total_height = self.height - header - footer
